...
/*
 * This is a Handle structure for a GPIO pin configuration settings
 */
...
typedef struct {
	...
	uint8_t GPIO_PinOPType;			/* possible values from @GPIO_PIN_OUTPUTS */
...
/*
 * @GPIO_PIN_PUPD
 * GPIO pin pull up and  pull down configurations macro
 */
...
/*
 * GPIO pin pull up pull down configurations macro
 */
/******************************************************************************
